...
useEffect(()=>{
    ...
    (async()=>{
      try{
        ...
        let response=await data.makeRequest({method:'get',url:`api/feedback/`+id,withToken:true, error: ``},0);
