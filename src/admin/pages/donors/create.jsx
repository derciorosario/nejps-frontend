 ...
 async function SubmitForm(){
  ...
  try{
   ...
   if(id){
     ...
     let r=await data.makeRequest({method:'post',url:`api/donor/`+id,withToken:true,data:form_data, error: ``},0);
     setForm({...form,r})
     ...
     let response=await data.makeRequest({method:'post',url:`api/donor/`,withToken:true,data:form_data, error: ``},0);
...
useEffect(()=>{
    ...
    (async()=>{
      try{
        ...
        let response=await data.makeRequest({method:'get',url:`api/donor/`+id,withToken:true, error: ``},0);
