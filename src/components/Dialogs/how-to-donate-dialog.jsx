              ...
              <div className="p-4 md:p-5">
                   ...
                   <div className="flex flex-wrap justify-around gap-x-2 px-2">
                       {data._settings?.whatsapp_contact && <a className="cursor-pointer py-2 flex items-center" onClick={()=>{
                           window.open(`https://wa.me/${whatsapp_contact}`,'_blank')
                       }}>
                       ...
                       {data._settings?.contact && <a href={`tel:${data._settings?.contact}`} className=" py-2 cursor-pointer flex items-center">
                       ...
                       {data._settings?.email && <a href={`mailto:${data._settings?.email}`} className=" py-2 cursor-pointer flex items-center">
